...
thumbnail: assets/img/news/COST RQI Logo B.png
images:
  compare: true
  slider: true
---
...
<img-comparison-slider>
  {% include figure.liquid path="assets/img/news/COST RQI Logo B.png" class="img-fluid rounded z-depth-1" slot="first" %}
  {% include figure.liquid path="assets/img/news/COST RQI Logo A.png" class="img-fluid rounded z-depth-1" slot="second" %}
</img-comparison-slider>

---

### **CA23115**: _Informação Quântica Relativística_ (`RQI`)
